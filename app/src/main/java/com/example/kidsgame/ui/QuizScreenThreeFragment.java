...
public class QuizScreenThreeFragment extends Fragment {

    private NavController navController;
    private ImageView myImageView;
    private TextView questionTextView;
    private Button choiceAButton, choiceBButton, choiceCButton, choiceDButton, backToMenuButtonThree;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_quiz_screen_three, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backToMenuButtonThree = view.findViewById(R.id.backToMenuButtonThree);
        ...
        backToMenuButtonThree.setOnClickListener(this::onbackToMenuButtonClick);
    ...
    private void fetchMathQuestions() {
        ...
        authService.getQuestions("seasons",language).enqueue(new Callback<FourChoiceQuestionResponse<FourChoiceQuestion>>() {
            @Override
            public void onResponse(Call<FourChoiceQuestionResponse<FourChoiceQuestion>> call, Response<FourChoiceQuestionResponse<FourChoiceQuestion>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    showAlert("QuizScreenThreeFragment", "Failed to fetch questions: " + response.message());
                }
            }

            @Override
            public void onFailure(Call<FourChoiceQuestionResponse<FourChoiceQuestion>> call, Throwable t) {
                showAlert("QuizScreenThreeFragment", "Failed to fetch questions: " + t.getMessage());
            }
        });
    }
    ...
    private void displayQuestion(int index) {
        if (index < questions.size()) {
            ...
            try {
                // GIF dosyasını Glide ile yükle
                Glide.with(this)
                        .asGif()
                        .load("file:///android_asset/seasonsQuestionsAssets/" + question.getQuestion() + ".gif")
                        .into(myImageView);
            ...
            navController.navigate(R.id.action_quizScreenThreeFragment_to_homeScreenFragment);
        }
    }
