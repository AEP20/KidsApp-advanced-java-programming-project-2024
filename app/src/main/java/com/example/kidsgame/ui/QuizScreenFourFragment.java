...
public class QuizScreenFourFragment extends Fragment {

    private NavController navController;
    private ImageView myImageView;
    private TextView questionTextView;
    private Button choiceAButton, choiceBButton, choiceCButton, choiceDButton,backToMenuButtonFour;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_quiz_screen_four, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backToMenuButtonFour = view.findViewById(R.id.backToMenuButtonFour);
        ...
        constraintLayout = view.findViewById(R.id.frameLayout6);

        navController = NavHostFragment.findNavController(this);

        backToMenuButtonFour.setOnClickListener(this::onbackToMenuButtonClick);
    ...
    private void fetchQuestions() {
        ...
        authService.getQuestions("direction",language).enqueue(new Callback<FourChoiceQuestionResponse<FourChoiceQuestion>>() {
            @Override
            public void onResponse(Call<FourChoiceQuestionResponse<FourChoiceQuestion>> call, Response<FourChoiceQuestionResponse<FourChoiceQuestion>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    showAlert("QuizScreenFourFragment", "Failed to fetch questions: " + response.message());
                }
            }

            @Override
            public void onFailure(Call<FourChoiceQuestionResponse<FourChoiceQuestion>> call, Throwable t) {
                showAlert("QuizScreenFourFragment", "Failed to fetch questions: " + t.getMessage());
            }
        });
    }
    ...
    private void displayQuestion(int index) {
        if (index < questions.size()) {
            ...
            try {
                InputStream inputStream = getActivity().getAssets().open("directionQuestionsAssets/" + question.getQuestion() + ".png");
            ...
            navController.navigate(R.id.action_quizScreenFourFragment_to_homeScreenFragment);
        }
    }
