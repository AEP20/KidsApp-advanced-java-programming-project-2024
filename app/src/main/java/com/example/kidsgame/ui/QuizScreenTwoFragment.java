...
public class QuizScreenTwoFragment extends Fragment {

    private NavController navController;
    private ImageView myImageView;
    private TextView questionTextView;
    private Button choiceAButton, choiceBButton, choiceCButton, choiceDButton, backToMenuButtonTwo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_quiz_screen_two, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backToMenuButtonTwo = view.findViewById(R.id.backToMenuButtonTwo);
        ...
        constraintLayout = view.findViewById(R.id.frameLayout4);

        navController = NavHostFragment.findNavController(this);

        backToMenuButtonTwo.setOnClickListener(this::onbackToMenuButtonClick);

        // Matematik soruları API'den çek ve göster
        fetchMathQuestions();
    }

    private void fetchMathQuestions() {
        String language = LocaleHelper.getCurrentLocale(getContext()).getLanguage();
        authService.getQuestions("math",language).enqueue(new Callback<FourChoiceQuestionResponse<FourChoiceQuestion>>() {
            @Override
            public void onResponse(Call<FourChoiceQuestionResponse<FourChoiceQuestion>> call, Response<FourChoiceQuestionResponse<FourChoiceQuestion>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    showAlert("QuizScreenTwoFragment", "Failed to fetch questions: " + response.message());
                }
            }

            @Override
            public void onFailure(Call<FourChoiceQuestionResponse<FourChoiceQuestion>> call, Throwable t) {
                showAlert("QuizScreenTwoFragment", "Failed to fetch questions: " + t.getMessage());
            }
        });
    }
    ...
    private void displayQuestion(int index) {
        if (index < questions.size()) {
            ...
            try {
                InputStream inputStream = getActivity().getAssets().open("mathQuestionsAssets/" + question.getQuestion() + ".png");
            ...
            navController.navigate(R.id.action_quizScreenTwoFragment_to_homeScreenFragment);
        }
    }
    ...
    private void showMotivationalMessage() {
        ...
        motivationalTextView.setLayoutParams(new ViewGroup.LayoutParams(
